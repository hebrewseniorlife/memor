...
$if(company)$
\rhead{\footnotesize \nouppercase{\sc $if(short_title)$$short_title$$else$\runtitle$endif$} \hspace{.025 in} \cdot \hspace{.055 in} \thepage \hspace{.01 in} / \pageref*{LastPage}}
$else$
\rhead{\footnotesize \nouppercase{\sc $if(short_title)$$short_title$$else$\runtitle$endif$}}
$endif$
