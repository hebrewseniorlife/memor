...
\makeatother
 ...
 \usepackage{fancyhdr}
  ...
  \rhead{ \footnotesize \nouppercase{\sc $if(short_title)$$short_title$$else$\runtitle$endif$} \hspace{.025 in} \cdot \hspace{.055 in} \thepage \hspace{.018 in} of \hspace{.0005 in} \pageref*{LastPage}}
...
$if(logo)$
\begin{flushright}
\includegraphics[height=$if(logo_height)$$logo_height$$else$1.2cm$endif$, keepaspectratio]{$logo$}
\end{flushright}
$endif$
