...
\captionsetup{font={color=$if(tabcapcolor)$$tabcapcolor$$else$black$endif$, sf}, skip=$if(tabcapskip)$$tabcapskip$$else$4pt$endif$, size=small, labelfont=sf, labelsep = period} % color and spacing between caption and table
