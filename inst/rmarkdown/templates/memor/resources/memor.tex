...
\let\runtitle\@title
$if(sdate)$
\newcommand{\rundate}{\hspace{.025 in} \hspace{.025 in} $sdate$}
$else$
\newcommand{\rundate}{}
$endif$
\makeatother
...
$if(company)$
\rhead{\footnotesize \nouppercase{\sc $if(short_title)$$short_title$$else$\runtitle$endif$} \hspace{.025 in} \hspace{.055 in} \thepage \hspace{.01 in} / \pageref*{LastPage}}
$else$
